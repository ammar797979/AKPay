...
# Configuration
NUM_TRANSACTIONS = 300000  # Generate 300,000 user-to-user transactions
...
# Generate SQL header
print("-- Generated INSERT statements for UserToUserTransactions table")
...
for _ in range(NUM_TRANSACTIONS):
    ...
    print(f"VALUES ({to_user}, {from_user}, {amount}, '{ts}', {status_id});")
...
# Configuration
NUM_TRANSACTIONS = 700  # Generate 700 user-to-user transactions
NUM_USERS = 500         # User IDs range from 1..500
