...
# Configuration
NUM_NOTIFICATIONS = 50000  # Generate 50,000 notifications (5% of 1M transactions)

# We have:
# - 500,000 RegularTransactions (IDs 1-500,000)
# - 200,000 TopUpTransactions (IDs 1-200,000)
# - 300,000 User-to-User transactions (IDs 1-300,000)
# - VendorPaymentTransaction (estimated)

# Transaction counts
REGULAR_TX_COUNT = 500000
TOPUP_TX_COUNT = 200000
VENDOR_PAY_TX_COUNT = 17  # One per vendor
U2U_TX_COUNT = 300000
