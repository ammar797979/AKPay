...
namespace AKPay.Entities
{
    internal interface IAKPayService
    {
        ...
        Task<bool> CreateBeneficiary(int remitterID, int beneficiaryID, string nickName = null);

        // Fetch List of Beneficiaries for 4.0, will this just call FetchBenfDetails multiple times? view?
        ...
        Task<bool> ChangePassword(string currentHash, string newHash, string retypeHash);
        ...
        Task<bool> Notified(string recipientType = "User", int recipientID, string msg, string notifType="Info", string txType=null, int txID=null);
    }
}